...
const Intro = () => {
  return (
    <div className="flex flex-col md:flex-row items-center justify-center space-x-48 px-6 md:px-12 py-10 bg-white">
      {/* Text Section */}
      <div className="max-w-lg text-center md:text-left space-y-4">
        ...
        <p className="text-lg text-gray-700">
          Dapatkan infonya dan langsung sewa di <span className="font-semibold">StayKos</span>.
        </p>
        ...
        <form className="flex w-full md:w-[420px] mx-auto md:mx-0 rounded-full border border-gray-300 bg-white shadow-md overflow-hidden focus-within:ring-2 focus-within:ring-black">
          ...
          />
          <Button type="submit" className="bg-black text-white rounded-full px-6 w-16 h-16 flex items-center justify-center" size="icon">
